...
class CausalSelfAttention(nn.Module):
    ...
    def __init__(self, config):
        ...
        self.n_embed, self.n_head, block_size= config.n_embed, config.n_head, config.block_size
        ...
        self.c_attn = nn.Linear(self.n_embed, self.n_embed * 3)
...
class GPT(nn.Module):
    ...
    def from_pretrained(cls, model_type):
        ...
        config_args = {
            "gpt2": dict(n_layer=12, n_head=12, n_embd=768), # I named n_layer n_block in my config. #FIXME: Also n_embd i named n_embed (must match gpt2 names?)
